...
class PmsRoomTypeRestrictionImporter(Component):
    _inherit = "channel.pms.room.type.restriction.importer"
    ...
    def import_restriction_plans(self):
        ...
        try:
            ...
            channel_restriction_obj = self.env["channel.pms.room.type.restriction"]
            restriction_mapper = self.component(
                usage="import.mapper", model_name="channel.pms.room.type.restriction"
            )
            for plan in results:
