...
class ChannelWubookPmsBoardServiceAdapter(Component):
    ...
    def create(self, values):
        raise ChannelAdapterError(
            _("Create operation is not supported on board services by Wubook")
        )
    ...
    def write(self, _id, values):
        raise ChannelAdapterError(
            _("Write operation is not supported on board service by Wubook")
        )

    def delete(self, _id):
        raise ChannelAdapterError(
            _("Delete operation is not supported on board servic by Wubook")
        )
