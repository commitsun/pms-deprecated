...
class PmsRoomTypeAvailabilityImporter(Component):
    _inherit = "channel.pms.room.type.availability.importer"
    ...
    def import_availability_values(self, date_from, date_to):
        ...
        try:
            ...
            _logger.info(
                "==[CHANNEL->ODOO]==== AVAILABILITY (%s - %s) ==", date_from, date_to
            )
            ...
            room_avail_mapper = self.component(
                usage="import.mapper", model_name="channel.pms.room.type.availability"
            )
                            ...
                            if room_type_avail_bind.channel_avail != room["avail"]:
                                ...
                                self.create_issue(
                                    ...
                                    internal_message=_(
                                        ...
                                        Updating channel values for Room Type "
                                        "%s... \
                                        (Odoo: %d -- Channel: %d)"
                                        % (
