...
class PmsRoomTypeImporter(Component):
    _inherit = "channel.pms.room.type.importer"
    ...
    def get_rooms(self):
        ...
        try:
            ...
            pms_room_type_class_obj = self.env["pms.room.type.class"]
            room_mapper = self.component(
                usage="import.mapper", model_name="channel.pms.room.type"
            )
            for room in results:
                room_type_class = pms_room_type_class_obj.search(
