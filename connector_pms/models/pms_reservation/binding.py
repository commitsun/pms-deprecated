...
class ChannelPmsReservation(models.Model):
    _name = "channel.pms.reservation"
    _inherit = "channel.binding"
    _inherits = {"pms.reservation": "odoo_id"}
    _description = "Channel PMS Reservation"
    ...
    ota_id = fields.Many2one("channel.ota.info", string="Channel OTA ID", readonly=True)
    ota_reservation_id = fields.Char("Channel OTA Reservation Code", readonly=True)
    ...
    channel_modified = fields.Boolean("Channel Modified", readonly=True, default=False)
    ...
    def refresh_availability(
        ...
        self.env["channel.pms.room.type.availability"].refresh_availability(
    ...
    def import_reservation(self, backend, channel_reservation_id):
        with backend.work_on(self._name) as work:
            importer = work.component(usage="pms.reservation.importer")
    ...
    def cancel_reservation(self):
        with self.backend_id.work_on(self._name) as work:
            exporter = work.component(usage="pms.reservation.exporter")
    ...
    def unlink(self):
        ...
        res = super(ChannelPmsReservation, self).unlink()
