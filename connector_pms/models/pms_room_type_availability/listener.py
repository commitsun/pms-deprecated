...
class BindingPmsRoomTypeAvailabilityListener(Component):
    _name = "binding.pms.room.type.availability.listener"
    _inherit = "base.connector.listener"
    _apply_on = ["pms.room.type.availability"]
    ...
    def on_record_write(self, record, fields=None):
        ...
        _logger.info("==[on_record_write] :: pms.room.type.availability==")
        _logger.info(fields)
        ...
        if not any(record.channel_bind_ids):
            ...
            for backend in backends:
                ...
                if not avail_bind:
                    ...
                    _logger.info("==[on_record_create] :: pms.room.type.availability==")
...
class ChannelBindingPmsRoomTypeAvailabilityListener(Component):
    _name = "channel.binding.pms.room.type.availability.listener"
    _inherit = "base.connector.listener"
    ...
    def on_record_write(self, record, fields=None):
        ...
        _logger.info("==[on_record_write] :: channel.pms.room.type.availability==")
        _logger.info(fields)
    ...
    def on_record_create(self, record, fields=None):
        if any(record.channel_bind_ids):
            ...
            _logger.info("==[on_record_create] :: channel.pms.room.type.availability==")
            _logger.info(fields)
