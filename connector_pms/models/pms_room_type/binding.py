...
class ChannelPmsRoomType(models.Model):
    _name = "channel.pms.room.type"
    _inherit = "channel.binding"
    _inherits = {"pms.room.type": "odoo_id"}
    _description = "Channel Pms Room"
    ...
    def import_rooms(self, backend):
        with backend.work_on(self._name) as work:
            importer = work.component(usage="pms.room.type.importer")
    ...
    def create_room(self):
        ...
        if not self.external_id:
            with self.backend_id.work_on(self._name) as work:
                exporter = work.component(usage="pms.room.type.exporter")
    ...
    def delete_room(self):
        ...
        if self.external_id:
            with self.backend_id.work_on(self._name) as work:
                deleter = work.component(usage="pms.room.type.deleter")
