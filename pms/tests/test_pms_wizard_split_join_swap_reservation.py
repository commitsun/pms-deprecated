...
class TestPmsWizardMassiveChanges(common.SavepointCase):
    ...
    # UNIFY TESTS
    def test_unify_reservatio_avail_should(self):
        # TEST CASE
    ...
    def test_unify_reservatio_avail_not(self):
        # TEST CASE
    ...
    def test_unify_reservatio_avail_not_room_exist(self):
        # TEST CASE
        # Unify reservation in one room and
    ...
    # SWAP TESTS
    def _test_swap_reservation_valid_01(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have the same checkin & checkout
        ...
        # ASSERT
        self.assertTrue(
            r1.reservation_line_ids.mapped('room_id') == self.room2 and
            r2.reservation_line_ids.mapped('room_id') == self.room1
        )

    def _test_swap_reservation_valid_02(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have different checkin & checkout
        # and there's availability for both rooms and both stays
    ...
    def _test_swap_reservation_valid_03(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have different checkin & checkout
        # and there's availability for both rooms and both stays
    ...
    def _test_swap_reservation_valid_04(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have different checkin & checkout
        # and there's availability for both rooms and both stays
    ...
    def _test_swap_reservation_valid_05(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have different checkin & checkout
        # and there's availability for both rooms and both stays
    ...
    def _test_swap_reservation_not_valid_01(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have different checkin & checkout
        # and there's no availability for one room
        # +------------+------+------+------+----+----+----+
        # | room/date  |  01  |  02  |  03  | 04 | 05 | 06 |
        # +------------+------+------+------+----+----+----+
        # | Double 101 |  r0  |  r1  |  r1  |    |    |    |
    ...
    def _test_swap_reservation_not_valid_02(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have different checkin & checkout
        # and there's no availability for one room
    ...
    def _test_swap_reservation_not_valid_03(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have different checkin & checkout
        # and there's no availability for one room
    ...
    def _test_swap_reservation_not_valid_04(self):
        # TEST CASE
        # Swap reservation rooms between 2 reservations
        # The reservations have different checkin & checkout
        # and there's no availability for one room
