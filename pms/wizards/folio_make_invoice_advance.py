...
class FolioAdvancePaymentInv(models.TransientModel):
    ...
    def _default_has_down_payment(self):
        if self._context.get('active_model') == 'pms.folio' and self._context.get('active_id', False):
    ...
    def _prepare_line(self, order, analytic_tag_ids, tax_ids, amount):
        ...
        so_values = {
            ...
            'tax_ids': [(6, 0, tax_ids)],
            'is_downpayment': True,
            'sequence': order.sale_line_ids and order.sale_line_ids[-1].sequence + 1 or 10,
        }
        del context
        return so_values
    ...
    def create_invoices(self):
        ...
        if self.advance_payment_method == 'delivered':
            ...
            for order in folios:
                ...
                line_values = self._prepare_line(order, analytic_tag_ids, tax_ids, amount)
